<template>
  <div class="pa-4">
    <h1 class="mb-2">Welcome back to TeamU</h1>
    <p class="mb-8">Continue with Google or enter your details</p>
    <v-btn
      class="mb-11"
      outlined
      large
    ...
    <v-form v-model="valid" @submit.prevent="submit">
      ...
      <p class="mt-6 text-center">
        ...
        <NuxtLink to="/auth/sign-up" class="font-weight-bold text-decoration-none">Sign up here</NuxtLink>
      </p>
    </v-form>
  </div>
</template>
